...
def config():
    ...
    for vehicle in vehicles:
        pool.append(Thread(target=vehicleEvent, args=(
            vehicle["vehicleId"], vehicle["vehiclePosition"])))
    for passenger in passengers:
        pool.append(Thread(target=passengerEvent, args=(
            passenger["passengerId"], passenger["startPosition"], passenger["endPosition"])))
    for one in pool:
        one.start()
