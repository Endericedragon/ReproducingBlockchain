...
function manageVehicleByRegion7(){
    ...
    for(let i = 0; i < passengerIdList.length; i++){
		let regionVehicles = [];
		let neighbourRegion = getNeighbour5(passengerPositionList[i].slice(0,7));
	...
	trafficContract.methods.getVehicleByRegion(web3.utils.asciiToHex(positionGeohash), regionVehicles).call({from: passengerId, gas: 500000000}).then(async function(result1){
		...
		trafficContract.methods.setVehicleStatus(result1[1], passengerId, web3.utils.asciiToHex(positionGeohash)).send({from: passengerId, gas: 5000000,position:"w3511111111111",txtime:278000}).then(function(result2){
            ...
            if(countNum == passengerIdList.length){
                let gname = "./coupleResult/region75_aveCenterCouple.json";
...
function getNeighbour5(hash)
{
	...
	var hash_top2 = CalculateAdjacent(hash_top,0);
	hash_neighbour.push(hash_top2);
	var hash_right2 = CalculateAdjacent(hash_right,1);
	hash_neighbour.push(hash_right2);
	var hash_bottom2 = CalculateAdjacent(hash_bottom,2);
	hash_neighbour.push(hash_bottom2);
	var hash_left2 = CalculateAdjacent(hash_left,3);
	hash_neighbour.push(hash_left2);
	...
	var hash_top2_left = CalculateAdjacent(hash_top2, 3);
	hash_neighbour.push(hash_top2_left);
	var hash_top2_right = CalculateAdjacent(hash_top2, 1);
	hash_neighbour.push(hash_top2_right);
	var hash_bottom2_left = CalculateAdjacent(hash_bottom2, 3);
	hash_neighbour.push(hash_bottom2_left);
	var hash_bottom2_right = CalculateAdjacent(hash_bottom2, 1);
	hash_neighbour.push(hash_bottom2_right);

	var hash_right2_top = CalculateAdjacent(hash_right2,0);
	hash_neighbour.push(hash_right2_top);
	var hash_right2_bottom = CalculateAdjacent(hash_right2,2);
	hash_neighbour.push(hash_right2_bottom);
	var hash_left2_top = CalculateAdjacent(hash_left2,0);
	hash_neighbour.push(hash_left2_top);
	var hash_left2_bottom = CalculateAdjacent(hash_left2,2);
	hash_neighbour.push(hash_left2_bottom);

	var hash_right2_top2 = CalculateAdjacent(hash_right2_top,0);
	hash_neighbour.push(hash_right2_top2);
	var hash_right2_bottom2 = CalculateAdjacent(hash_right2_bottom,2);
	hash_neighbour.push(hash_right2_bottom2);
	var hash_left2_top2 = CalculateAdjacent(hash_left2_top,0);
	hash_neighbour.push(hash_left2_top2);
	var hash_left2_bottom2 = CalculateAdjacent(hash_left2_bottom,2);
	hash_neighbour.push(hash_left2_bottom2);
