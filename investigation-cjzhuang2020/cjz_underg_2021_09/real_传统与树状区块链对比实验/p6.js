...
let passengerMessagesFile = "./passengerResult/system/30minP6.json";
let error1File = "./passengerResult/system/30minP6Err1.json";
let error2File = "./passengerResult/system/30minP6Err2.json";
