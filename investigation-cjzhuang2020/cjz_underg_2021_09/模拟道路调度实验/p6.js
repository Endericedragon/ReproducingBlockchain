...
let passengerMessagesFile = "./passengerResult/4region6_passenger.json";
let error1File = "./passengerResult/4p6Err1.json";
let error2File = "./passengerResult/4p6Err2.json";
