...
function getHowMuch(passengerNum, vehicleNum){
    ...
    fs.writeFileSync(getPassengerResult, JSON.stringify(passengerResult),{flag:'w',encoding:'utf-8',mode:'0666'},function(err){});
    fs.writeFileSync(getVehicleResult, JSON.stringify(vehicleResult),{flag:'w',encoding:'utf-8',mode:'0666'},function(err){});
}
getHowMuch(800, 560);
