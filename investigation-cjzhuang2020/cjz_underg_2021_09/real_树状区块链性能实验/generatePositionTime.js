...
function intersectionVehiclePositionTime(vehicleNum, duration){
    ...
    let intersections = JSON.parse(fs.readFileSync('./realIntersections.json', 'utf-8'));
    //初始化的位置时间
...
intersectionVehiclePositionTime(560, 60);
...
intersectionPassengerPositionTime(800, 60);
