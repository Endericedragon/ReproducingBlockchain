...
//Traffic contract
let trafficContractAddress = '0x13482b9ea283df8d15e24662b71cf25e7b820c9a';
...
async function passengerUnit(i){
	...
	await trafficContract.methods.initPassenger(passengerId, web3.utils.asciiToHex(passengerPositionList[i].start), web3.utils.asciiToHex(passengerPositionList[i].end)).send({from: passengerId, gas: 5000000,position:"w3511111111111",txtime:278000}).then(function(error, result){
