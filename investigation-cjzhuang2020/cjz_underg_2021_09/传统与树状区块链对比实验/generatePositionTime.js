...
function intersectionPassengerPositionTime(passengerNum, duration){
    ...
    for(let i = 0; i < initNum; i++){
        ...
        while(getDistanceByGeohash(startPosition.slice(0,10), endPosition.slice(0,10)) < 1500 || getDistanceByGeohash(startPosition.slice(0,10), endPosition.slice(0,10)) > 4000){
...
intersectionPassengerPositionTime(1200, 0);
