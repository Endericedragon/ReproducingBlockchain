...
let passengerMessagesFile = "./passengerResult/region6/1200P6.json";
let error1File = "./passengerResult/region6/1200P6Err1.json";
let error2File = "./passengerResult/region6/1200P6Err2.json";
